    ...
    public class MoodAnalyserFactory
    {
        public object CreateMoodAnalyser(string className, string constructorName)
        {
            ...
            if (result.Success)
            {
                ...
                {
                    throw new CustomMoodAnalyzerException(CustomMoodAnalyzerException.ExceptionType.NO_SUCH_CLASS, "Class Not Found" + className);

                }
            }
            else
            {
                throw new CustomMoodAnalyzerException(CustomMoodAnalyzerException.ExceptionType.NO_SUCH_METHOD, "Constructor is Not Found" + constructorName);
            }
        ...
        public  object CreateMoodAnalyserUsingParametrisedConstructor(string className, string ConstructorName, string message)
        {
            ...
            {
                throw new CustomMoodAnalyzerException(CustomMoodAnalyzerException.ExceptionType.NO_SUCH_CLASS, "Class is not found");
            }
